...
if __name__ == '__main__':
    ...
    root.title('Age Calculator Made by Kunal Desai')
    ...
    # Create a Day : label 
    day = Label(root, text = 'Day', bg = 'turquoise')

    # Create a Month : label 
    month = Label(root, text = 'Month', bg = 'turquoise')

    # Create a Year : label 
    year = Label(root, text = 'Year', bg = 'turquoise')

    # Create a Present Day : label 
    givenDay = Label(root, text = "Present Day", bg = "turquoise")

    # Create a Present Month : label 
    givenMonth = Label(root, text = "Present Month", bg = "turquoise")

    # Create a Present Year : label 
    givenYear = Label(root, text = "Present Year", bg = "turquoise")

    # Create a Years : label 
    rsltYear = Label(root, text = "Years", bg = "turquoise")

    # Create a Month : label 
    rsltMonth = Label(root, text = "Month", bg = "turquoise") 

    # Create a Days : label 
    rsltDay = Label(root, text = "Days", bg = "turquoise")
    ...
    resultantAge = Button(root, text = "KD Resultant Age", fg = "Black", bg = "Red", command = calculateAge)

    # Create a Clear All Button and attached to clearAll function
    clearAllEntry = Button(root, text = "KD Clear All Output", fg = 'Black', bg = 'Red', command = clearAll)
    ...
    clearAllEntry.grid(row = 14, column = 2) 
